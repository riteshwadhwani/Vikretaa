...
const sidebarLinks = [
  { path: '/buyer-dashboard', label: 'Dashboard', icon: FaHome },
  { path: '/buyer-dashboard/products', label: 'Products', icon: FaBox },
  { path: '/buyer-dashboard/my-bids', label: 'My Bids', icon: FaGavel },
  { path: '/buyer-dashboard/profile', label: 'Profile', icon: FaUser }
];
  ...
  return (
    <div className="min-h-screen text-black">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-[#0e0f14] shadow-lg transition-transform duration-200 ease-in-out ${
        ...
        <nav className="mt-5 px-4 hover:text-black">
            ...
            <Link
              ...
              className={`flex items-center px-4 py-3 mb-2 rounded-lg transition-colors ${
                location.pathname === path
                  ...
                  : 'text-white  hover:text-[#285380] hover:bg-blue-300 '
              }`}
            >
              <Icon className="mr-3" />
              {label}
